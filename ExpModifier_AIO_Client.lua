...
f_expmodifier_InnerText:SetText(
    "Allows you to change your experience multiplier.\n\nThis will allow you to gain more experience or less depending on your choice."
)
...
local f_expmodifier_InnerMyRate =
    f_expmodifier:CreateFontString(
    "f_expmodifier_InnerMyRate",
    function()
...
f_expmodifier_Button1:SetScript(
    "OnMouseUp",
    function()
        AIO.Handle("h_expmodifier", "setRateModifier", 1)
    end
)
...
f_expmodifier_Button2:SetScript(
    "OnMouseUp",
    function()
        AIO.Handle("h_expmodifier", "setRateModifier", 2)
    end
)
...
f_expmodifier_Button3:SetScript(
    "OnMouseUp",
    function()
        AIO.Handle("h_expmodifier", "setRateModifier", 3)
    end
)
...
f_expmodifier_Button4:SetScript(
    "OnMouseUp",
    function()
        AIO.Handle("Kaev", "AttributesDecrease", 1)
    end
)
